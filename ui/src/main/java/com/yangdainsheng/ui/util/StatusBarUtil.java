package com.yangdainsheng.ui.util;
...
public class StatusBarUtil {
  ...
  //屏幕适配
  public static void setStatusBarPaddingAndHeight(Context context, View toolBar) {
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
      if (toolBar != null) {
        ...
        toolBar.getLayoutParams().height = statusBarHeight +
                (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 44, context.getResources().getDisplayMetrics());
      }
    }
  }
}
